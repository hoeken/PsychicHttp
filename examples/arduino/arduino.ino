...
// #define this to enable SSL at build
...
void setup()
{
  ...
  if (connectToWifi()) {
    ...
    if (!LittleFS.begin()) {
      Serial.println("LittleFS Mount Failed. See https://randomnerdtutorials.com/esp32-littlefs-arduino-ide/ to upload filesystem.");
      return;
    }
